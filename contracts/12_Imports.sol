...
contract ImportsExercise {
    ...
    function getHaiku() public view returns (Silly_String_Utils.Haiku memory) {
        return haiku;
    }

    // Function to append a shrugging emoji to the third line of the Haiku
    function shruggieHaiku() public view returns (Silly_String_Utils.Haiku memory) {
        // Creating a copy of the Haiku
        Silly_String_Utils.Haiku memory newHaiku = haiku;
